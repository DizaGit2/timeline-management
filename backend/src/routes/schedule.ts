...
import { listSchedules, getSchedule, createSchedule, updateSchedule, deleteSchedule, copyWeek, publishSchedule, getShiftCount } from "../controllers/schedule";
...
router.get("/:id/shift-count", asyncHandler(getShiftCount));
...
router.post("/:id/publish", requireRole("MANAGER", "ADMIN"), asyncHandler(publishSchedule));
